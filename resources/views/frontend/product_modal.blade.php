                            ...
                            <div class="row setup-content" id="step-3">
                                <div class="col-md-10 col-sm-12 col-xs-12 m-auto mt-5">
                                    <table class="table ">
                                        <tbody>
                                            <tr>
                                                <th scope="col" class="text-center pln-ylw"></th>
                                                <th scope="col" class="text-center pln-ylw">
                                                ...
                                                <th scope="col" class="text-center pln-grn">
                                                    <div class="slide-header">
                                                        <div class="brand-logo">
                                                            <img src="{{ asset('public/frontend/assets/images/gkb.png') }}"
                                                                alt="diesel" width="100" height="27">
                                                ...
                                                <th scope="col" class="text-center pln-blu">
                                                    <div class="slide-header">
                                                        <div class="brand-logo">
                                                            <img src="{{ asset('public/frontend/assets/images/gkb.png') }}"
                                                                alt="diesel" width="100" height="27">
                                                ...
                                                <th scope="col" class="text-center pln-red">
                                                    <div class="slide-header">
                                                        <div class="brand-logo">
                                                            <img src="{{ asset('public/frontend/assets/images/gkb.png') }}"
                                                                alt="diesel" width="100" height="27">
