                    ...
                    <div class="col-md-2 col-xs-4">
                        <div class="ec_cat_inner">
                            <div class="ec-cat-image">
                                <a href="{{ route('search',) }}?subcategory={{$sub->slug}}"> <img src="{{asset('public/'.api_asset($sub->image))}}" alt="" /></a>
                            </div>
                            <div class="ec-cat-descs">
                                <a href="{{ route('search') }}?subcategory={{$sub->slug}}" class="text-center">{{$sub->name}}</a>
                            </div>
                        </div>
                    </div>
               @endforeach
