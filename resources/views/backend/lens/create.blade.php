                ...
                <div class="row m-1">
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.lens.index')}}">Add Lens</a></li>
                            <li class="breadcrumb-item active">Add Lens</li>
                        </ol>
                    </div>
                        ...
                        <div class="card card-outline card-info">
                            <div class="card-body p-0">
                                <div class="modal-body">
                                    <form action="{{route('admin.lens.store')}}" method="POST" class="form-example">
                                        @csrf
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="power_type" id="power_type" class="form-control" data-placeholder="Select Power Type"  required>
                                                                ...
                                                                <option value="Single Vision/Powered Eyeglasses">Single Vision/Powered Eyeglasses</option>
                                                                <option value="Zero Power Eyeglasses">Zero Power Eyeglasses</option>
                                                                <option value="Bifocal/Progressive Eyeglasses">Bifocal/Progressive Eyeglasses</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-3 brdr mb-3">
                                                    <div class="slide-container">
                                                        <div class="slide-content column-featureList">
                                                            <li class="featureList"> <input type="text" class="form-control" id="warranty_period" name="warranty_period" placeholder="Enter Warranty Period In Month..." required></li>
                                                            <li class="featureList"> <input type="text" class="form-control" id="thickeness" name="thickeness" placeholder="Enter Thickeness..." required></li>
                                                            <li class="featureList"> <input type="text" class="form-control" id="power_range" name="power_range" placeholder="Enter Power Range..." required></li>
                                                            <li class="featureList">
                                                                 <input type="checkbox" class="form-control" id="blue_light_blocker" name="blue_light_blocker" value="1">
                                                            </li>
                                                            <li class="featureList"> <input type="checkbox" class="form-control" id="anit_scratch_coating" name="anit_scratch_coating" value="1"></li>
                                                            <li class="featureList"> <input type="checkbox" class="form-control" id="b_anti_glare_coating" name="b_anti_glare_coating" value="1"></li>
                                                            <li class="featureList"> <input type="checkbox" class="form-control" id="b_anti_reflective_coating" name="b_anti_reflective_coating"  value="1"></li>
                                                            <li class="featureList"> <input type="checkbox" class="form-control" id="uv_protection" name="uv_protection" value="1"></li>
                                                            <li class="featureList"> <input type="checkbox" class="form-control" id="water_dust_replellent" name="water_dust_replellent" value="1"></li>
                                                            <li class="featureList"> <input type="checkbox" class="form-control" id="brekage_crack_resistance" name="brekage_crack_resistance" value="1"></li>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 brdr mb-3"></div>
                                        ...
                                        <div class="card-footer text-center">
                                            <button type="submit" class="btn btn-outline-success mt-1 mb-1" onclick="return confirm('Are you sure you want to Save this Lens?');"><i class="fa fa-check" aria-hidden="true"></i> SAVE</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
